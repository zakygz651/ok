...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:DEVELOPER KIZYY KANAERU => Owner : 083840910227\nX-WA-BIZ-NAME:KIZYY KANAERU\nEND:VCARD`})}
//=================================================//
